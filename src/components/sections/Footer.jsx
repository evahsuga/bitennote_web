        ...
        <Container>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <button
                    ...
                    className="hover:text-primary-coral transition-colors text-left"
                  >
                    プライバシーポリシー
                  </button>
                </li>
          ...
          <div className="border-t border-gray-700 pt-8 mb-8">
            <div className="text-center text-sm text-gray-500 leading-relaxed">
              ...
              <p className="mb-4">美点発見メソッドに共感した有志による、非営利の応援プロジェクトです。</p>
            </div>
          </div>

          {/* コピーライト */}
          <div className="text-center text-sm text-gray-500">
            <p>&copy; 2025 あなたと一緒に「美点発見」！ All rights reserved.</p>
          </div>
        </Container>
      </footer>
